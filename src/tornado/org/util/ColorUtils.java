...
public class ColorUtils {
    ...
    private final static float
            U_OFF = .436f,
            V_OFF = .615f;
    private static final long RAND_SEED = 3;
     ...
     */
    public Color[] generateVisuallyDistinctColors(int ncolors, float minComponent, float maxComponent) {
    ...
    public void hsv2rgb(float h, float s, float v, float[] rgb) {
    ...
    public void yuv2rgb(float y, float u, float v, float[] rgb) {
        rgb[0] = 1 * y + 0 * u + 1.13983f * v;
        rgb[1] = 1 * y + -.39465f * u + -.58060f * v;
        rgb[2] = 1 * y + 2.03211f * u + 0 * v;
    }

    public void rgb2yuv(float r, float g, float b, float[] yuv) {
